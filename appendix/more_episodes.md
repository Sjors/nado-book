...
Co-host Aaron is joined by Blockstream’s Lawrence Nahum, one of the developers of Jade Wallet, and Ben Kaufman, one of the developers of the Spectre wallet, the latter of which is specifically designed to work with hardware wallets.
...
One could write an entire book about Lightning. And in fact, others have, see e.g. _Mastering the Lightning Network: A Second Layer Blockchain Protocol for Instant Bitcoin Payments_ by Andreas M. Antonopoulos and Olaoluwa Osuntokun (aka Roasbeef).
