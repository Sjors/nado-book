...
However, when you look at the big picture, Guix doesn't solve the problem of dependencies much better than Gitian. It's still critical to keep the number of dependencies small. Guix mainly solves the problem of trusting the build system.
