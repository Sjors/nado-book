...
So you’d tell the person sending bitcoin either your public key or the hash of it. This is what addresses are for, as we explained in chapter 1. Then, they’d put that on the blockchain with a note on it saying that only the owner of that public key can spend the bitcoin.
...
The most commonly used (before SegWit, see chapter 3) Bitcoin Script reads as follows:
