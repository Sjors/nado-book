...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        -e|--epub) EBOOK="1" EPUB="1" EXTRA_OPTIONS="-o nado-kindle.epub -t epub3 --css epub.css -V ebook -V epub --metadata-file meta-epub.yaml --toc-depth=2 --top-level-division=part --epub-cover-image=meta/front.jpg --webtex=https://latex.codecogs.com/svg.latex?";;
